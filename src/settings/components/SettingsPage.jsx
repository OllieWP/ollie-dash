                    ...
                    <Flex direction="column" align="start" justify="flex-start" gap="0"
                        ...
                        <div className={"ollie-back-to-dash"}>
                            <a href={ollie_options.dashboard_link}><Dashicon
                                icon="wordpress"/> {__('Back to Dashboard', 'ollie-dash')}</a>
                        </div>
                            ...
                            <FlexItem>
                                {activeItem === '/' &&
                                    <div className={"ollie-panel-description"}>
                                        <h1 className={"settings-headline edit-site-sidebar-navigation-screen__title"}>{__('Ollie Dashboard', 'ollie-dash')}</h1>
                                        <p className="edit-site-sidebar-navigation-screen__description">
                                            {__('Here, you\'ll find everything you need to get started building with the Ollie theme.', 'ollie-dash')}
                                        </p>
                                    </div>
                                }
                                {activeItem === '/onboarding' &&
                                    <div className={"ollie-panel-description"}>
                                        <h1 className={"settings-headline edit-site-sidebar-navigation-screen__title"}>{__('Ollie Theme Setup', 'ollie-dash')}</h1>
                                        <p className="edit-site-sidebar-navigation-screen__description">
                                            {__('Welcome to the Ollie setup wizard! We\'ll help you get your site up and running in just a few minutes.', 'ollie-dash')}
                                        </p>
                                    </div>
                                }
                                {activeItem === '/documentation' &&
                                    <div className={"ollie-panel-description"}>
                                        <h1 className={"settings-headline edit-site-sidebar-navigation-screen__title"}>{__('Ollie Docs', 'ollie-dash')}</h1>
                                        <p className="edit-site-sidebar-navigation-screen__description">
                                            {__('Learn how to build beautiful, blazing fast websites with Ollie and the WordPress site editor.', 'ollie-dash')}
                                        </p>
                                    </div>
                                }
                                {activeItem === '/videos' &&
                                    <div className={"ollie-panel-description"}>
                                        <h1 className={"settings-headline edit-site-sidebar-navigation-screen__title"}>{__('Ollie Videos', 'ollie-dash')}</h1>
                                        <p className="edit-site-sidebar-navigation-screen__description">
                                            {__('Learn how to build beautiful, blazing fast websites with Ollie and the WordPress site editor.', 'ollie-dash')}
                                        </p>
                                    </div>
                                ...
                                <Flex direction="column" align="start" justify="flex-start" gap="0"
                                    ...
                                    <NavigatorButton onClick={() => setActiveItem('/')}
                                                     ...
                                                     path="/">
                                        <Icon icon={home}/> {__('Welcome', 'ollie-dash')}
                                    </NavigatorButton>
									<NavigatorButton 
