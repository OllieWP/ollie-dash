...
function DocsBlockThemes() {
    return (
		...
		<h2 id="block-theme-intro">
			{__('Working with Block Themes', 'ollie-companion')}
		</h2>
		...
		<h3 id="site-editor">
			{__('Site Editor', 'ollie-companion')}
		</h3>
		...
		<h3 id="global-styles">
			{__('Global Styles', 'ollie-companion')}
		</h3>
		...
		<h3 id="site-export">
			{__('Export Your Site', 'ollie-companion')}
		</h3>
