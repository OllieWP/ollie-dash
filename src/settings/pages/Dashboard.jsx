    ...
    return (
        <div className={"ollie-inner-settings"}>
            <div className={"ollie-dash-hero"}>
                <div className="ollie-dash-container">
                    ...
                    <Flex gap={"75px"} className="ollie-dash-hero-content">
                        <FlexItem>
                            <h1>{__('Welcome to Ollie, the future of WordPress site building.', 'ollie-companion')}</h1>
                            <p>{__('A new era of site building has arrived in WordPress. With the powerful new site editor, you can build beautiful, blazing-fast websites natively right inside WordPress — no page builder plugins required.', 'ollie-companion')}</p>
                            <p>{__('Ollie is a block theme designed and built to work seamlessly with the new site editor. Ollie is also a handy educational resource, helping you learn the new WordPress interface and workflows so you can launch quicker. Ready to get started?', 'ollie-companion')}</p>
                            <NavigatorButton variant="primary" onClick={() => setActiveItem('/onboarding')}
                                             className={activeItem === '/onboarding' ? 'ollie-nav-is-active' : ''}
                                             path="/onboarding">
                                <HStack spacing="3">
                                    <span>{__('Go to the Setup Wizard', 'ollie-companion')}</span> <Icon icon={arrowRight}/>
                                </HStack>
                            </NavigatorButton>
                        </FlexItem>
                        <FlexItem>
            ...
            <div className="ollie-dash-content">
                <div className="ollie-dash-container">
					<Flex className="ollie-dash-content-intro">
						<h2>{__('Get Started with Ollie', 'ollie-companion')}</h2>
					</Flex>
                    <Grid className={"ollie-dash-boxes"} columns={3} gap={8}>
                        <Card>
                            <CardHeader size="large">
                                <h3>{__('Ollie Setup Wizard', 'ollie-companion')}</h3>
                            </CardHeader>
                            <CardBody size="large">
                                <img src={onboardingWizard}/>
                                <p>{__('The Ollie Setup Wizard makes setting up your site a breeze. Choose your styles, create some pages, and you’re ready to go!', 'ollie-companion')}</p>
                            </CardBody>
                            <CardFooter size="large">
                                <NavigatorButton variant="secondary" onClick={() => setActiveItem('/onboarding')}
                                                 className={activeItem === '/onboarding' ? 'ollie-nav-is-active' : ''}
                                                 path="/onboarding">
                                    {__('Start Site Setup', 'ollie-companion')}
                                </NavigatorButton>
                            </CardFooter>
                        </Card>
                        <Card>
                            <CardHeader size="large">
                                <h3>{__('Learn with Docs and Videos', 'ollie-companion')}</h3>
                            </CardHeader>
                            <CardBody size="large">
                                <img src={onboardingVideo}/>
                                <p>{__('Learn how to design in the WordPress editor, how to work with patterns, how to use all of the powerful Ollie features, and more.', 'ollie-companion')}</p>
                            </CardBody>
                            <CardFooter size="large">
                                <NavigatorButton variant="secondary" onClick={() => setActiveItem('/documentation')}
                                                 ...
                                                 path="/documentation">
                                    {__('Browse the Ollie Docs', 'ollie-companion')}
                                </NavigatorButton>
                            </CardFooter>
                        </Card>
                        ...
                        <Card>
                            <CardHeader size="large">
                                <h3>{__('Get Help', 'ollie-companion')}</h3>
                            </CardHeader>
                            <CardBody size="large">
                                <img src={onboardingSupport}/>
                                <p>{__('Having trouble with your theme or want to report an issue? Submit an issue through the Ollie GitHub repo and we\'ll help out.', 'ollie-companion')}</p>
                            </CardBody>
                            <CardFooter size="large">
                                <Button href="https://github.com/OllieWP/ollie/issues/new/choose" variant="secondary">
                                    {__('Visit Ollie on Github', 'ollie-companion')}
                                </Button>
                            </CardFooter>
                        </Card>
                    </Grid>
            ...
            <div className="ollie-dash-content ollie-dash-content-alt">
                <div className="ollie-dash-container">
					<Flex className="ollie-dash-content-intro" >
						<h2>{__('Ollie Video Tutorials', 'ollie-companion')}</h2>
						<NavigatorButton variant="secondary" onClick={() => setActiveItem('/videos')}
											path="/videos">
							{__('View Full Video Library', 'ollie-companion')}
						</NavigatorButton>
					</Flex>
                    <Grid className={"ollie-dash-boxes"} columns={3} gap={8}>
						<Video 
